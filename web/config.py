...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:zehaoz_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:659248683008:zehaoz_job_results"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "zehaoz_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "zehaoz@mpcs-cc.com"

  # Time before free user results are archived (in seconds)
  FREE_USER_DATA_RETENTION = 300

  RESTORE_ARN = "arn:aws:sns:us-east-1:659248683008:zehaoz_glacier_restore"
